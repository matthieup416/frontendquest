...
function HomeScreen(props) {
  ...
  // const [overlayData, setOverlayData] = useState({ max_price: "", min_price: "", max_surface: "", min_surface: "", outdoor_surface: "", pieces_max: "", pieces_min: "", elevator: "", parking: "", is_old: "", is_new: "", fiber_optics: "", pool: "", balcony: "", terrace: "", created: "", market_date: "", open_to_pro: "", })
            ...
            return (
              <View
                ...
                <View
                  ...
                  <CreatButton textStyle={{ fontWeight: "bold" }} onPress={() => toggleOverlay()}>Détails</CreatButton>
                  ...
                  <CreatButton
                    ...
                    buttonStyle={{ backgroundColor: "orange" }} textStyle={{ fontWeight: "bold" }}>
                    {offers} RÉSULTATS
                  </CreatButton>
                </View>
              </View>
